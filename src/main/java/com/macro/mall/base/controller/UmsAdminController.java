...
import com.macro.mall.base.dto.UmsAdminLoginParam;
...
import com.macro.mall.base.service.UmsRoleService;
...
////        BeanUtils.copyProperties(umsAdminParam, umsAdmin1);
    ...
    public CommonResult delete(@PathVariable Long id) {
        ...
        if (admin!=null &&(admin.getStatus()==1)){
            return CommonResult.failed("启用状态下不能删除！");
        }
