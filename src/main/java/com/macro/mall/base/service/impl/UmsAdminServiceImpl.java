...
import com.macro.mall.base.bo.AdminUserDetails;
import com.macro.mall.base.dao.UmsAdminPermissionRelationDao;
import com.macro.mall.base.dao.UmsAdminRoleRelationDao;
import com.macro.mall.base.dto.UmsAdminParam;
import com.macro.mall.base.dto.UpdateAdminPasswordParam;
...
import com.macro.mall.base.service.UmsAdminService;
...
//        if(null==loginLog.getAddress()){
//            loginLog.setAddress("1");
//        }
//        if(null==loginLog.getUserAgent()){
...
//        }
    ...
    public List<UmsAdmin> list(String keyword, Integer pageSize, Integer pageNum) {
        ...
        example.setOrderByClause("id ,create_time desc");
    ...
    public UserDetails loadUserByUsername(String username){
        ...
        if (admin != null) {
            if (admin.getStatus()==0){
                throw new UsernameNotFoundException("该帐号已经被禁用！");
            }
