...
public class WARUtil {
	...
	private String config = "uat";
	private String pro = "mall"; //当前生成工程名

//	private String patchFile = "D:/版本/AppPrj/tap.txt"; // SVN增量文件名
	private String patchFile = getLastPath(); // SVN增量文件名
	private String desPath = "D:/版本/出库版本/mall"; // 增量文件位置

	public WARUtil() {
		this.projectPath = System.getProperty("user.dir").replace("\\", "/");
		this.webContent = "WebContent";
		this.classPath = projectPath + "/" + webContent + "/WEB-INF/classes";
	...
	public static String getLastPath(){
		 ...
		 List<String> ls = Arrays.asList(new File(path).list());
