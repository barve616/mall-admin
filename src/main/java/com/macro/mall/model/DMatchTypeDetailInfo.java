...
public class DMatchTypeDetailInfo implements Serializable {
    ...
    private byte[] matchDetails;
    @ApiModelProperty(value = "赛事资讯详情String")
    private String matchDetailsString;
    @ApiModelProperty(value = "赛事副标题")
    ...
    public String getMatchDetailsString() {
        return matchDetailsString;
    }

    public void setMatchDetailsString(String matchDetailsString) {
        this.matchDetailsString = matchDetailsString;
    }
    ...
    public byte[] getMatchDetails() {
        return matchDetails;
    }

    public void setMatchDetails(byte[] matchDetails) {
