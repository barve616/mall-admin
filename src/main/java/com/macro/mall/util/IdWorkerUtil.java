...
public class IdWorkerUtil {
    ...
    private static class SnowflakeIdWorkerHolder {
        public final static IdWorkerUtil instance = new IdWorkerUtil();
    }

    private IdWorkerUtil() {
        Random r = new Random();
        new IdWorkerUtil( Math.abs(r.nextInt()%32), Math.abs(r.nextInt()%32));
    }
    ...
    public static void main(String[] args) {
        ...
        Random r = new Random();
        System.out.println( Math.abs(r.nextInt()%32));
        System.out.println( Math.abs(r.nextInt()%32));
    }
}