...
//    private String funcsId;
    ...
    private List<DCmsRegion> cityList;
    private List<DCmsPeople> peopleType;
    ...
    public List<DCmsRegion> getCityList() {
        return cityList;
    }

    public void setCityList(List<DCmsRegion> cityList) {
        this.cityList = cityList;
    }

    public List<DCmsPeople> getPeopleType() {
        return peopleType;
    }

    public void setPeopleType(List<DCmsPeople> peopleType) {
